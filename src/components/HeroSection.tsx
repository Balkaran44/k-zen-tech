...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative pt-24 md:pt-36 pb-16 md:pb-24 overflow-hidden hero-gradient interactive-bg">
      <ParticlesBackground className={isMobile ? "opacity-30" : "opacity-70"} />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className={`flex flex-col sm:flex-row gap-4 justify-center lg:justify-start transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
              <a href="#services" className="w-full sm:w-auto">
                <Button 
                  ...
                  className="w-full sm:w-auto bg-kzen-600 hover:bg-kzen-700 text-white btn-glow transition-all duration-300 transform hover:scale-105 group"
                >
                  Explore Solutions
              ...
              <Link to="/blog" className="w-full sm:w-auto">
                <Button 
                  variant="outline"
                  size={isMobile ? "default" : "lg"} 
                  className="w-full sm:w-auto border-kzen-600 text-kzen-400 hover:bg-kzen-900/20 hover:text-kzen-300 group"
                >
                  Learn More
          ...
          <div className={`relative transition-all duration-1000 delay-300 mt-6 sm:mt-0 ${isLoaded ? 'opacity-100' : 'opacity-0 translate-x-10'}`}>
            <div className="absolute -top-10 -left-10 w-24 sm:w-32 h-24 sm:h-32 bg-kzen-500/10 rounded-full blur-3xl animate-pulse-soft"></div>
            <div className="absolute -bottom-10 -right-10 w-24 sm:w-32 h-24 sm:h-32 bg-blue-500/10 rounded-full blur-3xl animate-pulse-soft" style={{ animationDelay: '1s' }}></div>
            ...
            <div className="relative z-10 rounded-xl overflow-hidden shadow-2xl animate-float">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 transform translate-y-0 opacity-100 transition-all duration-300">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 sm:w-40 h-32 sm:h-40 bg-kzen-500/20 rounded-full blur-2xl animate-pulse-soft -z-10"></div>
          </div>
